    ...
    <div className="border border-r-0 border-l-0 border-t-0 border-gray-600 border-b-[1px] cursor-pointer pt-3 pr-4 pl-4">
        <div className="grid grid-cols-12">
            <div className="col-span-1">
                {data?.author?.profileImageUrl && <Image className="rounded-full" src={data.author.profileImageUrl} alt="user-img" height={50} width={50}/>}
            </div>
            <div className="col-span-11">
                {data?.author?.firstName && <div className="flex justify-between">
                    <h5 className="pl-2 font-semibold">{data?.author?.firstName} {data?.author?.lastName}</h5>
                ...
                <div className="px-2 py-1">
                   {data.imageURL && <Image className="rounded-lg" src={data.imageURL} priority={false} alt="user-img" height={400} width={600}/>}
                </div>
